...
public interface IEnforcementService {
     ...
     */
    EEnforcementJob createEnforcementJob(EEnforcementJob job);
     ...
     * @return created enforcement job
     */
    EEnforcementJob createEnforcementJob(String agreementId);
     ...
     * Get job by id
     */
    EEnforcementJob getEnforcementJob(Long id);
    
    /**
     * Get job by related agreementId
     */
    EEnforcementJob getEnforcementJobByAgreementId(String agreementId);
    
    /**
     * Get all enforcement jobs
     */
    List<EEnforcementJob> getEnforcementJobs();
     ...
     */
    void saveEnforcementResult(EAgreement agreement, Map<EGuaranteeTerm, GuaranteeTermEvaluationResult> result);
     ...
     */
    void doEnforcement(EAgreement agreement, Map<EGuaranteeTerm, List<IMonitoringMetric>> metrics);
    
    
    void saveCheckedGuaranteeTerm(EGuaranteeTerm term);
