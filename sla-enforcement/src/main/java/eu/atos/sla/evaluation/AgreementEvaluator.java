...
public class AgreementEvaluator {
     ...
     */
    public Map<EGuaranteeTerm, GuaranteeTermEvaluationResult> evaluate(EAgreement agreement,
            Map<EGuaranteeTerm, List<IMonitoringMetric>> metricsMap) {

        checkInitialized(false);
        
        Map<EGuaranteeTerm,GuaranteeTermEvaluationResult> result = 
                new HashMap<EGuaranteeTerm,GuaranteeTermEvaluationResult>();
        
        Date now = new Date();
        for (EGuaranteeTerm term : metricsMap.keySet()) {
     ...
     * @return list of violations and compensations detected.
     */
    public Map<EGuaranteeTerm, GuaranteeTermEvaluationResult> evaluateBusiness(EAgreement agreement,
        ...
        Date now = new Date();
        for (EGuaranteeTerm term : violationsMap.keySet()) {

            List<EViolation> violations = violationsMap.get(term);
