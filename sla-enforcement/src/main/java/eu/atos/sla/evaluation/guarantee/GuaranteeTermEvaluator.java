...
public class GuaranteeTermEvaluator {
    ...
    public static final class GuaranteeTermEvaluationResult {
        private final List<EViolation> violations;
        private final List<? extends ECompensation> compensations;

        public GuaranteeTermEvaluationResult(List<EViolation> violations,
        ...
        public List<? extends ECompensation> getCompensations() {
    ...
    public GuaranteeTermEvaluationResult evaluate(
        ...
        final List<EViolation> violations = serviceLevelEval.evaluate(agreement, term, metrics, now);
        logger.debug("Found " + violations.size() + " violations");
        final List<? extends ECompensation> compensations = businessEval.evaluate(agreement, term, violations, now);
    ...
    public GuaranteeTermEvaluationResult evaluateBusiness(
            EAgreement agreement, EGuaranteeTerm term, List<EViolation> violations, Date now) {
