...
public class SimpleMetricsTranslator implements IMetricTranslator<SimpleMetricsTranslator.SimpleMetricsReceiverData> {
    ...
    @Override
    public Map<EGuaranteeTerm, List<IMonitoringMetric>> translate(
            final EAgreement agreement, final SimpleMetricsReceiverData data) {
        
        Map<EGuaranteeTerm, List<IMonitoringMetric>> result = 
