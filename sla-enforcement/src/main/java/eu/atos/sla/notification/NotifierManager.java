...
public class NotifierManager  implements INotifierManager ,InitializingBean, Runnable {
    ...
    public void addToBeNotified(EAgreement agreement,
    ...
    protected class ResultInformation{
        ...
        protected ResultInformation(EAgreement agreement, Map<EGuaranteeTerm, GuaranteeTermEvaluationResult> evaluationResult){
