...
public interface SLAConstants {
  String EXCHANGE_NAME_FM = "symbiote.fm";
  String SLA_REGISTRATION_QUEUE_NAME = "symbIoTe.fm.sla.registration";
  String SLA_UNREGISTRATION_QUEUE_NAME = "symbIoTe.fm.sla.unregistration";
  String FEDERATION_REGISTRATION_KEY = "federation.registration";
}
