...
public interface IAgreementDAO {
     ...
     */
    public List<EAgreement> getByActiveAgreements(long actualDate);
     ...
     * @throws Exception 
     */
    public EAgreement save(EAgreement agreement);
     ...
     */
    public boolean delete(EAgreement agreement);
    ...
    public EAgreement getById(Long id);
