...
public interface IEnforcementJobDAO {
     ...
     */
    List<EEnforcementJob> getNotExecuted(Date since);
     ...
     */
    EEnforcementJob getById(Long id);
     ...
     */
    EEnforcementJob getByAgreementId(String agreementId);
     ...
     */
    public List<EEnforcementJob> getAll();
     ...
     * @throws Exception 
     */
    public EEnforcementJob save(EEnforcementJob expected);
     ...
     */
    public boolean delete(EEnforcementJob enforcementJob);
