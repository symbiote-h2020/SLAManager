...
public interface IGuaranteeTermDAO {
     ...
     */
    public EGuaranteeTerm getById(Long id);
     ...
     */
    public List<EGuaranteeTerm> getAll();
     ...
     * @throws Exception
     */
    public EGuaranteeTerm save(EGuaranteeTerm guaranteeTerm);
     ...
     */
    public boolean delete(EGuaranteeTerm guaranteeTerm);
