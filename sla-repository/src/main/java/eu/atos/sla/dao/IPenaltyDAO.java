...
public interface IPenaltyDAO {
     ...
     */
    public EPenalty getById(Long id);
     ...
     */
    public EPenalty save(EPenalty penalty);
    ...
    /**
     * Gets the last penalty raised for a given (agreement, definition, kpi name); null if not found
     */
