...
public interface IPolicyDAO {
     ...
     */
    public EPolicy getById(Long id);
     ...
     * @throws Exception 
     */
    public EPolicy save(EPolicy policy);
     ...
     */
    public boolean update(EPolicy policy);
     ...
     */
    public boolean delete(EPolicy policy);
