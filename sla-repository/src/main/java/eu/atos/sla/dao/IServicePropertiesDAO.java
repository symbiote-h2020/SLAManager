...
public interface IServicePropertiesDAO  {
     ...
     */
    public EServiceProperties getById(Long id);
     ...
     */
    public EServiceProperties getByName(String serviceName);
     ...
     */
    public List<EServiceProperties> getAll();
     ...
     * @throws Exception 
     */
    public EServiceProperties save(EServiceProperties serviceProperties);
     ...
     */
    public boolean delete(EServiceProperties serviceProperties);
