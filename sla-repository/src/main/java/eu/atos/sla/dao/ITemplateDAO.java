...
public interface ITemplateDAO  {
     ...
     */
    public ETemplate getById(Long id);
     ...
     * @return the corresponding Template from the database
     */
    public List<ETemplate> search(String providerUuid, String []serviceIds);
     ...
     */
    public boolean delete(ETemplate template);
