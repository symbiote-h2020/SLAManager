...
public interface IVariableDAO  {
     ...
     */
    public EVariable getById(Long id);
     ...
     * @return the corresponding Variable from the database
     */
    public EVariable getByName(String variableName);
     ...
     * @throws Exception 
     */
    public EVariable save(EVariable variable);
     ...
     */
    public boolean delete(EVariable variable);
