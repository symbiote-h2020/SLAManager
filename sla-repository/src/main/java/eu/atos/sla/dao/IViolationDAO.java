...
public interface IViolationDAO {
     ...
     */
    public EViolation getById(Long id);
     ...
     * @return the corresponding Violation from the database
     */
    public List<EViolation> getByAgreementIdInARangeOfDates(
    ...
    public List<EViolation> getByAgreement(String contractUuid,
            String termName);
     ...
     * @throws Exception
     */
    public EViolation save(EViolation violation);
     ...
     */
    public List<EViolation> getByProvider(String providerId);
     ...
     */
    public List<EViolation> getByProviderInaRangeOfDates(String providerId,
            Date begin, Date end);
     ...
     * @param uuid
     *            of the Violation
     * @return the corresponding Violation from the database or null
     */
    public Date getLastViolationDate(
            EAgreement agreement, String kpiName);
