...
public class PolicyDAOJpaTest extends
    ...
    public void getById() {
        ...
        EPolicy guaranteeFromDatabase = policyDAO.getAll().get(size);
        ...
        EPolicy nullPolicy = policyDAO.getById(new Long(30000));
    ...
    public void detete() {
        ...
        EPolicy policyFromDatabase = policyDAO.getAll().get(size);
