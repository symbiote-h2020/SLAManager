...
public class TemplateDAOJpaTest extends
    ...
    public void save() {
        ...
        EProvider psaved = new EProvider();
        try {
    ...
    public void getById() {
        ...
        ETemplate nullTemplate = templateDAO.getById(new Long(30000));
    ...
    public void detete() {
        ...
        Long id = saved.getId();
        ETemplate templateFromDatabase = templateDAO.getById(id);
    ...
    public void update() {
        ...
        ETemplate templateFromDatabase = templateDAO.getAll().get(size);
