...
public class EnforcementJobHelperE{
    ...
    public List<EnforcementJob> getEnforcements() {
        ...
        List<EEnforcementJob> storedEnforcementJobs  = this.enforcementJobDAO.getAll();
        List<EnforcementJob> enforcementJobs = new ArrayList<EnforcementJob>(); 
        for (EEnforcementJob storedEnforcementJob:storedEnforcementJobs) enforcementJobs.add(modelConverter.getEnforcementJobXML(storedEnforcementJob));
    ...
    public EnforcementJob getEnforcementJobByUUID(String agreementUUID) {
        ...
        EEnforcementJob storedEnforcementJob = this.enforcementJobDAO.getByAgreementId(agreementUUID);
    ...
    public String createEnforcementJob(EnforcementJob enforcementJobXML)
        ...
        EEnforcementJob enforcementJob = null;
        EEnforcementJob stored = null;
        ...
        try {
            if (enforcementJobXML != null) {
                if (!doesEnforcementExistInRepository(enforcementJobXML.getAgreementId())) {
                    ...
                    EAgreement agreement = agreementDAO.getByAgreementId(enforcementJobXML.getAgreementId());
                    if (agreement == null)
