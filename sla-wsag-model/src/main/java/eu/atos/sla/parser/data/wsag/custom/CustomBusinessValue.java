...
public class CustomBusinessValue {
    ...
    public CustomBusinessValue(int count, Duration duration, List<Penalty> penalties) {
        this(count, duration, penalties, "");
    }

    public CustomBusinessValue(int count, Duration duration, List<Penalty> penalties, String description) {
        this.count = count;
    ...
    public String toString() {
        return String.format(
                "CustomBusinessValue [count=%s, duration=%s, penalties=%s, description=%s]",
                count, duration, penalties, description);
    }
}
